...
아이디어가 떠오르면 **기획부터 개발 · 배포까지 혼자서** — '진짜 작동하는 제품'으로 만듭니다.
...
- 🛠️ **직접 만들어 공개한 프로젝트 30개 이상** — 시작하면 끝까지, 그리고 공개합니다
- 🧩 **웹 · 데스크톱 앱 · 자동화 도구 · AI 서비스**까지 분야를 가리지 않습니다
- 🤖 **Claude · GPT · Gemini · Ollama** 등 여러 AI를 직접 연동해 도구를 만듭니다
- ⚡ 기획 → 개발 → 배포까지 **혼자서 빠르게** 완성합니다
- 📚 새로운 기술을 빠르게 흡수해 **바로 실전에 적용**합니다
