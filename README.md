...
# 👋 안녕하세요, SoDam AI Studio 입니다

#### 🚀 AI를 무기로, 아이디어를 빠르게 '진짜 제품'으로 만드는 1인 메이커

웹 서비스 · 데스크톱 앱 · AI 자동화 도구 — **기획부터 개발 · 배포까지 직접 합니다**
...
- 🛠️ **직접 만들어 공개한 프로젝트 30개 이상** — 만들기 시작하면 끝까지, 그리고 공개합니다
- 🧩 웹 · 데스크톱 앱 · 자동화 도구 · AI 서비스까지 **분야를 가리지 않습니다**
...
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:startmxk@gmail.com)
